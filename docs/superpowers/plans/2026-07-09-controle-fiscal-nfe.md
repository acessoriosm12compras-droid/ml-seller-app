...
- O certificado (.pfx) de cada CNPJ **nunca** é gravado em disco — decodificado em memória a partir de `CERT_PFX_BASE64_{CONTA}` (env var), senha em `CERT_PFX_SENHA_{CONTA}`.
